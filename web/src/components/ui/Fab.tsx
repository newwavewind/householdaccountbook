  ...
  return (
    <button
      ...
      className={[
        ...
        'rounded-full border border-green-accent bg-green-accent text-on-accent transition-all duration-200 ease-out theme2:rounded-md theme2:border-charcoal-border',
