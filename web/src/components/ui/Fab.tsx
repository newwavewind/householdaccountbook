...
export function Fab({
  ...
  return (
    <button
      ...
      aria-label={label}
      className={[
        'fixed bottom-[calc(3.25rem+1rem+env(safe-area-inset-bottom,0px))] right-[max(1rem,env(safe-area-inset-right))] z-50 flex h-14 w-14 cursor-pointer items-center justify-center md:bottom-[max(1rem,env(safe-area-inset-bottom))]',
