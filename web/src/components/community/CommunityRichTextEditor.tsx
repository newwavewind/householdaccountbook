      ...
      <div className="border-b border-border-muted bg-neutral-warm/60">
        ...
        >
          ...
          <Button
            type="button"
            variant="outlined"
            className="!border-[#FF0000] !bg-transparent !px-2 !py-0.5 !text-xs !text-[#FF0000] hover:!bg-[#FF0000]/10"
            disabled={disabled}
            onClick={() => setYoutubeOpen(true)}
          >
            <span className="inline-flex items-center gap-0.5">
              <svg className="h-3 w-3 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                <path d="M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 0 0 .5 6.2 31.6 31.6 0 0 0 0 12a31.6 31.6 0 0 0 .5 5.8 3 3 0 0 0 2.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 0 0 2.1-2.1A31.6 31.6 0 0 0 24 12a31.6 31.6 0 0 0-.5-5.8zM9.5 15.6V8.4L15.8 12l-6.3 3.6z" />
              </svg>
              YouTube
            </span>
          </Button>
